...
import com.harshRajpurohit.musicPlayer.albumfunctions.AlbumListSongActivity
...
import com.harshRajpurohit.musicPlayer.dialogFlow.RecommendActivity
...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    companion object {
        lateinit var musicListPA: MutableList<Music>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.timerBtnPA.setOnClickListener {
            ...
            if (!timer) showBottomSheetDialog()
                ...
                builder.setTitle("Bộ hẹn giờ")
                    .setMessage("Bạn có muốn hẹn giờ kết thúc phát nhạc không?")
        ...
        binding.favouriteBtnPA.setOnClickListener {
            fIndex = musicListPA[songPosition].id?.let { it1 -> favouriteChecker(it1) }!!
            if (isFavourite) {
                isFavourite = false
    ...
    private fun initializeLayout() {
        ...
        when (intent.getStringExtra("class")) {
            ...
            "RecommendActivity" -> initServiceAndPlaylist(
                RecommendActivity.recommendList,
                shuffle = false
            )

            "TopicListActivity" -> initServiceAndPlaylist(
                TopicListActivity.musicListTopic,
                shuffle = false
            )

            "AlbumSongActivity" -> initServiceAndPlaylist(
                AlbumListSongActivity.albumListSong,
                shuffle = false
            )

            "BannerLayout" -> initServiceAndPlaylist(MainActivity.MusicListRL, shuffle = false)
        }
    ...
    private fun setLayout() {
        ...
        val img = musicListPA[songPosition].path?.let { getImgArt(it) }
    ...
    private fun showBottomSheetDialog() {
        ...
        dialog.findViewById<LinearLayout>(R.id.min_15)?.setOnClickListener {
            Toast.makeText(baseContext, "Music sẽ dừng sau 15 phút", Toast.LENGTH_SHORT)
                .show()
        ...
        dialog.findViewById<LinearLayout>(R.id.min_30)?.setOnClickListener {
            Toast.makeText(baseContext, "Music sẽ dừng sau 30 phút", Toast.LENGTH_SHORT)
                .show()
            binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this, R.color.purple_500))
            min30 = true
            Thread {
        ...
        dialog.findViewById<LinearLayout>(R.id.min_60)?.setOnClickListener {
            Toast.makeText(baseContext, "Music sẽ dừng sau 60 phút", Toast.LENGTH_SHORT)
                .show()
            binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this, R.color.purple_500))
            min60 = true
            Thread {
    ...
    private fun initServiceAndPlaylist(
        ...
        setLayout()
        if (!playNext) PlayNext.playNextList = mutableListOf()
    }
}